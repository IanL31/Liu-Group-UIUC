...
//  man->SetNtupleMerging(true);
  ...
  //Tabulate deposited energy on the detector ONLY FROM BACKGROUND SPECTRUM
  man->CreateNtuple("EdepBKG","EdepBKG");
  man->CreateNtupleDColumn("fEdep_HPGe_BKGonly");
  man->FinishNtuple(1);

  //These are old; if you would like to use them, adjust accordingly
  //Tabulate isotope decay count
/*  man->CreateNtuple("Isotope","Isotope");
  man->CreateNtupleIColumn("Iso1_Count");
  man->CreateNtupleIColumn("Iso2_Count");
  man->CreateNtupleIColumn("Iso3_Count");
  man->CreateNtupleIColumn("Iso4_Count");
  man->CreateNtupleIColumn("Iso5_Count");
  man->CreateNtupleIColumn("Iso6_Count");
  man->FinishNtuple(1);*/
